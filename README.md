...
Bistro is a simple recipe search and management application for the GNOME desktop. It allows you to find recipes for cocktails and meals using free online databases, organize your favorite recipes in a personal collection, and manage your shopping list.
